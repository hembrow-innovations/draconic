//! ROADMAP D05: strip / LTO flags documented and invokable together.
...
#[test]
fn build_native_strip_and_lto_flags_are_invokable_together() {
    let dir = temp_dir();
    ...
    assert!(
        out.is_file(),
        "stripped LTO native binary missing at {}",
        out.display()
    );
