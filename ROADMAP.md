...
| N08.06.04 | todo | native | Real native observations: spread in call/new args (E06.04) — `es/arrays/call_spread` asserts program results (native.stdout), not B08 hello | `tests/conformance` fixture `es/arrays/call_spread`, `crates/draconic-backend-llvm` |
