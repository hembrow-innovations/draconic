...
| E19.11 | todo | js | Compound assignment to property: `obj.p op= v` / `obj[k] op= v` (currently compile reject “not yet supported”) | `crates/draconic-check` / IR, `tests/test262` |
