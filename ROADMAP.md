...
| N08.05.02 | todo | native | Real native observations: class heritage (E05.02) — `es/classes/class_extends` asserts program results (native.stdout), not B08 hello | `tests/conformance` fixture `es/classes/class_extends`, `crates/draconic-backend-llvm` |
