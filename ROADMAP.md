...
| N08.16.43 | todo | native | Real native observations: `for await…of` (E18.42) (children below) | `tests/conformance` fixture `es/annex-b/for_await_of`, `crates/draconic-backend-llvm` |
...
| N08.16.43.02 | todo | native | Real native observations: `for await` over `Symbol.asyncIterator` custom async iterables; enable native on full `for_await_of` | `tests/conformance` fixture `es/annex-b/for_await_of`, `crates/draconic-backend-llvm` |
