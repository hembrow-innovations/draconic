...
| E19.82 | todo | js | Class residual II: subclass builtin remaining, private async/generator method names, class elements residual after E19.81 | `crates/draconic-parser` / backend-js, `tests/test262` |
