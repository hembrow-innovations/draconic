...
| E19.84.08 | todo | js | Deferred ns module evaluation errors: `module-throws/*` (throw on EnsureDeferredNamespaceEvaluation; same reason after eager eval; `assert.deepEqual` harness) | `crates/draconic-linker` / harness, `tests/test262` |
