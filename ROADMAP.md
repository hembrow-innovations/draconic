...
| N08.16.18 | blocked | native | Real native observations: regexp literals (E18.18) — `es/annex-b/regexp_literal` asserts program results (`native.stdout`), not B08 hello | fixture `es/annex-b/regexp_literal`, `crates/draconic-backend-llvm` |
