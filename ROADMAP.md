...
| N08.06 | todo | native | Real native observations: arrays (E06) (children below) | `tests/conformance` fixtures `es/arrays` |
...
| N08.06.05 | todo | native | Real native observations: `for-of` over arrays (E06.05) — `es/arrays/array_for_of` asserts program results (native.stdout), not B08 hello | `tests/conformance` fixture `es/arrays/array_for_of`, `crates/draconic-backend-llvm` |
| N08.06.06 | todo | native | Real native observations: array destructuring (E06.06) — `es/arrays/array_destructure` asserts program results (native.stdout), not B08 hello | `tests/conformance` fixture `es/arrays/array_destructure`, `crates/draconic-backend-llvm` |
