...
| E19.46 | todo | js | Computed property names in object binding patterns: `{ [expr]: v }` in params/dstr/assignment (currently “not yet supported”) | `crates/draconic-parser` / check, `tests/test262` |
