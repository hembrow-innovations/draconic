...
| N08.16.18 | in_progress | native | Real native observations: regexp literals (E18.18) — `es/annex-b/regexp_literal` asserts program results (`native.stdout`), not B08 hello | fixture `es/annex-b/regexp_literal`, `crates/draconic-backend-llvm` |
...
| N08.16.25 | blocked | native | Real native observations: parameter destructuring (E18.25) — `es/annex-b/param_destructure` asserts program results (`native.stdout`), not B08 hello | fixture `es/annex-b/param_destructure`, `crates/draconic-backend-llvm` |
