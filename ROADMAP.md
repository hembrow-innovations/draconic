...
| N08.06.02 | todo | native | Real native observations: array element assignment (E06.02) — `es/arrays/array_element_assign` asserts program results (native.stdout), not B08 hello | `tests/conformance` fixture `es/arrays/array_element_assign`, `crates/draconic-backend-llvm` |
| N08.06.03 | todo | native | Real native observations: spread in array literals (E06.03) — `es/arrays/array_spread` asserts program results (native.stdout), not B08 hello | `tests/conformance` fixture `es/arrays/array_spread`, `crates/draconic-backend-llvm` |
