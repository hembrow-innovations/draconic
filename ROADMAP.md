...
| N08.09.02 | todo | native | Real native observations: Symbol property keys (E09.02) | `tests/conformance` fixture `es/values/symbol_property_keys`, `crates/draconic-backend-llvm` |
