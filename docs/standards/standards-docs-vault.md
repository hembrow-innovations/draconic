...
- **Public site is not the vault**: Learn and Reference sources live in the sibling `draconic-web` repo ([[0010-public-docs-draconic-ssg]], [[0013-public-site-tanstack-start]], [[guides-public-docs]]). Agent and toolchain notes stay here.
