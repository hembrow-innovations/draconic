...
Public Learn and Reference sources live in the sibling `draconic-web` repo, not this vault ([[0010-public-docs-draconic-ssg]], [[0013-public-site-tanstack-start]], [[guides-public-docs]]). Agent and toolchain notes stay in this vault.
...
- **draconic-web**: public site sources in the sibling repo, not this vault ([[0010-public-docs-draconic-ssg]], [[0013-public-site-tanstack-start]]).
