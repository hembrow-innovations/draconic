...
#[test]
fn class_expr_fixture_present() {
    assert_fixture_present("es/annex-b/class_expr");
}
...
#[test]
fn private_methods_fixture_present() {
    assert_fixture_present("es/annex-b/private_methods");
}
