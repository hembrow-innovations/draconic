...
#[test]
fn with_export_star_from_fixture_present() {
    assert_fixture_present("es/legacy/with_export_star_from");
}
...
#[test]
fn with_namespace_import_fixture_present() {
    assert_fixture_present("es/legacy/with_namespace_import");
}
...
#[test]
fn implicit_global_logical_fixture_present() {
    assert_fixture_present("es/legacy/implicit_global_logical");
}
...
#[test]
fn implicit_global_binary_fixture_present() {
    assert_fixture_present("es/legacy/implicit_global_binary");
}
