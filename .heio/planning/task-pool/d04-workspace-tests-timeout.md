---
id: "d04-workspace-tests-timeout"
...
Reviewer miss on [[s-d04-workspace-tests]]. O1 matched EXPECT but `exit=timeout`. Not a product fail. Not a new D04 Loop atom. Do not restore live `.yml` names. D04 / D04.02 / D01.01 stay `done`.
...
[[s-d04-workspace-tests-timeout]] [[ticket-191-d04-workspace-tests-timeout]]
