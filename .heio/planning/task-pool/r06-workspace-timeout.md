...
Reviewer miss on [[s-r06]]. O3 matched EXPECT but `exit=timeout`. Not a product fail. Not a new R06 Loop atom. R06 stays `done`.
...
[[s-r06-workspace-timeout]] [[ticket-199-r06-workspace-timeout]]
