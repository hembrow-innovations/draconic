...
TanStack Start presentation; ODM public site chrome as the visual and docs-shell reference; keep markdown teaching sources and fence contract; pivot if the fence pipeline cannot be retargeted without lying.
