...
caused-by: s-l10-02-workspace-timeout
failed: true
intent: fix
---
...
Reviewer miss on [[s-l10-02-workspace-timeout]]. L10.02 stays `done` on ROADMAP.md. Beat the workspace oracle, not a new language atom.
