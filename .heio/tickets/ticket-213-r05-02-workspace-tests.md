...
caused-by: s-r05-02-workspace-tests
failed: true
intent: fix
---
...
Reviewer miss on [[s-r05-02-workspace-tests]]. R05.02 stays `done` on ROADMAP.md. Beat the workspace oracle, not a new language atom.
