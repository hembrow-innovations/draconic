...
Reviewer miss on [[slice-366-l07-02-workspace-tests]]. Not a new ROADMAP atom. L07.02 stays `done` on ROADMAP.md. Next Builder must beat the failed oracles, not re-open the language row.

- **caused-by**: slice-366-l07-02-workspace-tests
