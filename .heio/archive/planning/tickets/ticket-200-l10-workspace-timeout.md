...
Reviewer miss on [[slice-378-l10]]. This is a budget miss, not a new ROADMAP atom. L10 stays `done` on ROADMAP.md. Next Builder must beat the oracle budget on `cargo test --workspace`, not re-open the language row.

- **caused-by**: slice-378-l10
- **failed oracle**: O3
