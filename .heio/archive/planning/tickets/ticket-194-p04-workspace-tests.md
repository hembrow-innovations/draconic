...
Reviewer miss on [[slice-380-p04]]. Not a new ROADMAP atom. P04 stays `done` on ROADMAP.md. Next Builder must beat the failed workspace oracle, not re-open the language row.

- **caused-by**: slice-380-p04
- **failed oracle**: O2
