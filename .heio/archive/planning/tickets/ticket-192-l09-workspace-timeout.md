...
Reviewer miss on [[slice-373-l09]]. This is a budget miss, not a new ROADMAP atom. L09 stays `done` on ROADMAP.md. Next Builder must beat the oracle budget on `cargo test --workspace`, not re-open the language row.

- **caused-by**: slice-373-l09
- **failed oracle**: O2
