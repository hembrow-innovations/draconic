...
Reviewer miss on [[slice-398-r05]]. This is a budget miss, not a new ROADMAP atom. R05 / R05.01 stay `done` on ROADMAP.md. Next Builder must beat the oracle budget on `cargo test --workspace`, not re-open the language row.

- **caused-by**: slice-398-r05
- **failed oracle**: O2
