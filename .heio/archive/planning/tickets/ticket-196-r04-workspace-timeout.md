...
Reviewer miss on [[slice-394-r04]]. This is a budget miss, not a new ROADMAP atom. R04 / R04.01 / R04.02 stay `done` on ROADMAP.md. Next Builder must beat the oracle budget on `cargo test --workspace`, not re-open the language row.

- **caused-by**: slice-394-r04
- **failed oracle**: O3
