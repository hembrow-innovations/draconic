...
Reviewer miss on [[slice-396-r05-02]]. Not a new ROADMAP atom. R05.02 stays `done` on ROADMAP.md. Next Builder must beat the failed workspace oracle, not re-open the language row.

- **caused-by**: slice-396-r05-02
- **failed oracle**: O3
