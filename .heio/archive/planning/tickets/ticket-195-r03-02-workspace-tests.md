...
Reviewer miss on [[slice-390-r03-02]]. Not a new ROADMAP atom. R03.02 stays `done` on ROADMAP.md. Next Builder must beat the failed workspace oracle, not re-open the language row.

- **caused-by**: slice-390-r03-02
- **failed oracle**: O2
