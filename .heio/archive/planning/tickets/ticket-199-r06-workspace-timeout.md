...
Reviewer miss on [[slice-400-r06]]. This is a budget miss, not a new ROADMAP atom. R06 stays `done` on ROADMAP.md. Next Builder must beat the oracle budget on `cargo test --workspace`, not re-open the language row.

- **caused-by**: slice-400-r06
- **failed oracle**: O3
