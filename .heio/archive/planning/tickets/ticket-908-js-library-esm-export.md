...
First cut landed: [[slice-909-entry-export-table]] and [[slice-911-js-library-named-esm]] are met. Closed. Remainder: [[ticket-913-default-js-build-no-esm]] parked; [[ticket-914-js-library-default-export]] and [[ticket-915-js-library-export-star]] promoted. Does not rewrite [[location-220-packages]] or [[location-224-distribution]]. Not AFK from this ticket.
...
- Named `--library` emit landed. [[slice-909-entry-export-table]] and [[slice-911-js-library-named-esm]] are met. Node `import { name } from` works for named exports and named re-exports.
- Remainder applied this sitting: 913 parked; 914 and 915 promoted into [[slice-916-js-library-default-export]] and [[slice-918-js-library-export-star]].

**Recommended ticket_type:** feature-request

**Recommended status:** closed

**One-line reason:** First-cut named library emit landed; remaining children have their own tickets.

**Applied:** Closed and archive-moved.
