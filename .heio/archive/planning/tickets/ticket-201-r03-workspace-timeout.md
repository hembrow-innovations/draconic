...
Reviewer miss on [[slice-392-r03]]. This is a budget miss, not a new ROADMAP atom. R03 stays on ROADMAP.md as the Builder left it. Next Builder must beat the oracle budget on `cargo test --workspace`, not re-open the language row.

- **caused-by**: slice-392-r03
- **failed oracle**: O2
