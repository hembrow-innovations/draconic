---
id: "slice-245-d03-02-workspace-tests"
...
- **Re-opening [[slice-246-d03-02]]**: that slice stays sealed `failed`
...
- `[[task-421-d03-02-workspace-tests]]`

## See also

ROADMAP.md D03.02, `tests/integration/tests/reproducible_emit.rs`, `crates/draconic-pkg/src/later.rs`, CONTEXT.md, [[location-224-distribution]], [[slice-246-d03-02]], [[ticket-129-d03-02-workspace-tests]].
