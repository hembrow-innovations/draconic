---
id: "slice-344-k11-04-workspace-timeout"
...
Review of [[slice-345-k11-04]] left ROADMAP K11.04 unfinished: O1 (`draconic-pkg` k11_04) held, but O2 `cargo test --workspace` timed out at 120s. The packages location still needs the K11.04 Loop to leave the workspace green, not only the module proxy/mirror crate tests.
...
- **Re-opening [[slice-345-k11-04]]**: that slice stays sealed `failed`
...
- `[[task-520-k11-04-workspace-timeout]]`

## See also

ROADMAP.md K11.04, `crates/draconic-pkg`, docs/adr/0009-go-style-git-packages.md, CONTEXT.md, `.heio/planning/locations/location-220-packages.md`, [[slice-345-k11-04]], [[ticket-176-k11-04-workspace-timeout]].
