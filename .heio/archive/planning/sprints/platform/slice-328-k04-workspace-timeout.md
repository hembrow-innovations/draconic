---
id: "slice-328-k04-workspace-timeout"
...
Review of [[slice-329-k04]] left ROADMAP K04 unfinished: O1 (`draconic-pkg` resolve) held, but O2 `cargo test --workspace` timed out at 120s. The packages location still needs the K04 Loop to leave the workspace green, not only the semver-tag → commit OID fail-closed crate tests.
...
- **Re-opening [[slice-329-k04]]**: that slice stays sealed `failed`
...
- `[[task-504-k04-workspace-timeout]]`

## See also

ROADMAP.md K04, `crates/draconic-pkg/src/resolve.rs`, `crates/draconic-pkg`, docs/adr/0009-go-style-git-packages.md, CONTEXT.md, `.heio/planning/locations/location-220-packages.md`, [[slice-329-k04]], [[ticket-168-k04-workspace-timeout]].
