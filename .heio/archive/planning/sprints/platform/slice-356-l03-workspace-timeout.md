---
id: "slice-356-l03-workspace-timeout"
...
Review of [[slice-357-l03]] left ROADMAP L03 unfinished: O1 (`stdlib_crypto`) held, but O2 `cargo test --workspace` timed out at 120s. The stdlib location still needs the L03 Loop to leave the workspace green, not only the crypto conformance fixtures for SHA-256 digest and secure random bytes.
...
- **Re-opening [[slice-357-l03]]**: that slice stays sealed `failed`
...
- `[[task-532-l03-workspace-timeout]]`

## See also

ROADMAP.md L03, `tests/conformance/tests/stdlib_crypto.rs`, `tests/conformance/fixtures/stdlib/crypto`, CONTEXT.md, [[location-223-stdlib]], [[slice-357-l03]], [[ticket-181-l03-workspace-timeout]].
