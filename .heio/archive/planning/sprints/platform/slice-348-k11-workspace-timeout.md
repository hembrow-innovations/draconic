---
id: "slice-348-k11-workspace-timeout"
...
Review of [[slice-349-k11]] left ROADMAP K11 unfinished: O1 (`draconic-pkg` k11) held, but O2 `cargo test --workspace` timed out at 120s. The packages location still needs the K11 Loop to leave the workspace green, not only the post-v1 packaging crate tests.
...
- **Re-opening [[slice-349-k11]]**: that slice stays sealed `failed`
...
- `[[task-524-k11-workspace-timeout]]`

## See also

ROADMAP.md K11, `crates/draconic-pkg`, docs/adr/0009-go-style-git-packages.md, CONTEXT.md, `.heio/planning/locations/location-220-packages.md`, [[slice-349-k11]], [[ticket-178-k11-workspace-timeout]].
