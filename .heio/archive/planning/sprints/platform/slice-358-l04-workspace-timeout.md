---
id: "slice-358-l04-workspace-timeout"
...
Review of [[slice-359-l04]] left ROADMAP L04 unfinished: O1 (`stdlib_compression`) held, but O2 `cargo test --workspace` timed out at 120s. The stdlib location still needs the L04 Loop to leave the workspace green, not only the gzip/deflate byte-buffer conformance fixtures.
...
- **Re-opening [[slice-359-l04]]**: that slice stays sealed `failed`
...
- `[[task-534-l04-workspace-timeout]]`

## See also

ROADMAP.md L04, `tests/conformance/tests/stdlib_compression.rs`, `tests/conformance/fixtures/stdlib/compression`, CONTEXT.md, [[location-223-stdlib]], [[slice-359-l04]], [[ticket-182-l04-workspace-timeout]].
