---
id: "slice-258-d05-01-workspace-timeout"
...
Review of [[slice-259-d05-01]] left ROADMAP D05.01 unfinished: O1 (`strip_symbols`) and O2 (`binary_size_strip`) held, but O3 `cargo test --workspace` timed out at 120s. The distribution location still needs the D05.01 Loop to leave the workspace green, not only the CLI/build strip-symbols suite.
...
- **Re-opening [[slice-259-d05-01]]**: that slice stays sealed `failed`
...
- `[[task-434-d05-01-workspace-timeout]]`

## See also

ROADMAP.md D05.01, `crates/draconic-cli`, `tests/integration`, CONTEXT.md, [[location-224-distribution]], [[slice-259-d05-01]], [[ticket-134-d05-01-workspace-timeout]].
