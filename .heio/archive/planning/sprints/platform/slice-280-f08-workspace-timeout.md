---
id: "slice-280-f08-workspace-timeout"
...
Review of [[slice-281-f08]] left ROADMAP F08 unfinished: O1 (`ffi_policy`) held, but O2 `cargo test --workspace` timed out at 120s. The ffi location still needs the F08 Loop to leave the workspace green, not only the ffi/policy harness.
...
- **Re-opening [[slice-281-f08]]**: that slice stays sealed `failed`
...
- `[[task-456-f08-workspace-timeout]]`

## See also

ROADMAP.md F08, `tests/conformance/tests/ffi_policy.rs`, `tests/conformance/fixtures/ffi/policy`, `crates/draconic-check`, docs/adr/0003-gc-runtime-and-dual-worlds.md, CONTEXT.md, [[location-221-ffi]], [[slice-281-f08]], [[ticket-144-f08-workspace-timeout]].
