---
id: "slice-318-h17-04-workspace-timeout"
...
Review of [[slice-319-h17-04]] left ROADMAP H17.04 unfinished: O1 (`host_policy`) held, but O2 `cargo test --workspace` timed out at 120s. The host-io location still needs the H17.04 Loop to leave the workspace green, not only the host policy conformance harness for the optional JS/Node bridge.
...
- **Re-opening [[slice-319-h17-04]]**: that slice stays sealed `failed`
