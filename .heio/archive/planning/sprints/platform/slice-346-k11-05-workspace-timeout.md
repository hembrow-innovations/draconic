---
id: "slice-346-k11-05-workspace-timeout"
...
Review of [[slice-347-k11-05]] left ROADMAP K11.05 unfinished: O1 (`draconic-pkg` yank) held, but O2 `cargo test --workspace` timed out at 120s. The packages location still needs the K11.05 Loop to leave the workspace green, not only the yank/retract crate tests.
...
- **Re-opening [[slice-347-k11-05]]**: that slice stays sealed `failed`
...
- `[[task-521-k11-05-workspace-timeout]]`

## See also

ROADMAP.md K11.05, `crates/draconic-pkg`, docs/adr/0009-go-style-git-packages.md, CONTEXT.md, `.heio/planning/locations/location-220-packages.md`, [[slice-347-k11-05]], [[ticket-177-k11-05-workspace-timeout]].
