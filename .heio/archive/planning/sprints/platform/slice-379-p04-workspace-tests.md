---
id: "slice-379-p04-workspace-tests"
...
Review of [[slice-380-p04]] left O2 unmet: `cargo test --workspace` exited 101. P04 stays `done`. Beat the workspace oracle, not a new language atom.
...
- **Re-opening [[slice-380-p04]]**: sealed `failed`
...
- `[[task-555-p04-workspace-tests]]`

## See also

ROADMAP.md P04, [[ticket-194-p04-workspace-tests]], [[slice-380-p04]].
