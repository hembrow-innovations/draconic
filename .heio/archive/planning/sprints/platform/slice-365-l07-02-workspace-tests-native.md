---
id: "slice-365-l07-02-workspace-tests-native"
...
Review of [[slice-366-l07-02-workspace-tests]] left O1 and O2 unmet: native `build_native_binary` failed with `runtime C source missing` at a stale pi-worktree `CARGO_MANIFEST_DIR`. L07.02 stays `done` on ROADMAP.md. This cut beats those oracles without re-opening the language row.
...
- **Re-opening [[slice-366-l07-02-workspace-tests]] / [[slice-368-l07-02]]**: those slices stay sealed
...
- `[[task-541-l07-02-workspace-tests-native]]`

## See also

ROADMAP.md L07.02, `crates/draconic-runtime/src/draconic_rt.c`, `crates/draconic-runtime/src/lib.rs`, `tests/conformance/tests/stdlib_flags.rs`, [[ticket-190-l07-02-workspace-tests-native]], [[slice-366-l07-02-workspace-tests]].
