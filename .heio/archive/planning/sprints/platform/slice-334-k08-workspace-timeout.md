---
id: "slice-334-k08-workspace-timeout"
...
Review of [[slice-335-k08]] left ROADMAP K08 unfinished: O1 (`draconic-pkg` hash) held, but O2 `cargo test --workspace` timed out at 120s. The packages location still needs the K08 Loop to leave the workspace green, not only the lock-hash verify / refuse-tampered-cache crate tests.
...
- **Re-opening [[slice-335-k08]]**: that slice stays sealed `failed`
...
- `[[task-510-k08-workspace-timeout]]`

## See also

ROADMAP.md K08, `crates/draconic-pkg/src/hash.rs`, `crates/draconic-pkg`, docs/adr/0009-go-style-git-packages.md, CONTEXT.md, `.heio/planning/locations/location-220-packages.md`, [[slice-335-k08]], [[ticket-171-k08-workspace-timeout]].
