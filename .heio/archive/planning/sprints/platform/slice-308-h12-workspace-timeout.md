---
id: "slice-308-h12-workspace-timeout"
...
Review of [[slice-309-h12]] left ROADMAP H12 unfinished: O1 (`host_ws`) held, but O2 `cargo test --workspace` timed out at 120s. The host-io location still needs the H12 Loop to leave the workspace green, not only the host WebSocket conformance harness.
...
- **Re-opening [[slice-309-h12]]**: that slice stays sealed `failed`
