---
id: "slice-272-f03-workspace-timeout"
...
Review of [[slice-273-f03]] left ROADMAP F03 unfinished: O1 (`ffi_layout`) held, but O2 `cargo test --workspace` timed out at 120s. The ffi location still needs the F03 Loop to leave the workspace green, not only the layout harness.
...
- **Re-opening [[slice-273-f03]]**: that slice stays sealed `failed`
...
- `[[task-448-f03-workspace-timeout]]`

## See also

ROADMAP.md F03, `tests/conformance/tests/ffi_layout.rs`, `tests/conformance/fixtures/ffi/layout`, `crates/draconic-backend-llvm`, docs/adr/0003-gc-runtime-and-dual-worlds.md, CONTEXT.md, [[location-221-ffi]], [[slice-273-f03]], [[ticket-140-f03-workspace-timeout]].
