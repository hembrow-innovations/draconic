---
id: "slice-260-d05-02-workspace-timeout"
...
Review of [[slice-261-d05-02]] left ROADMAP D05.02 unfinished: O1 (`lto_flag`) and O2 (`binary_size_lto`) held, but O3 `cargo test --workspace` timed out at 120s. The distribution location still needs the D05.02 Loop to leave the workspace green, not only the CLI/build LTO flag and size-delta suite.
...
- **Re-opening [[slice-261-d05-02]]**: that slice stays sealed `failed`
...
- `[[task-436-d05-02-workspace-timeout]]`

## See also

ROADMAP.md D05.02, `crates/draconic-cli`, `tests/integration`, CONTEXT.md, [[location-224-distribution]], [[slice-261-d05-02]], [[ticket-135-d05-02-workspace-timeout]].
