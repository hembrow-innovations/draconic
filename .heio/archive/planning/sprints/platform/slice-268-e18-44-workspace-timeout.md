---
id: "slice-268-e18-44-workspace-timeout"
...
Review of [[slice-269-e18-44]] left ROADMAP E18.44 unfinished: O1 (annex-b harness) held, but O2 `cargo test --workspace` timed out at 120s. The conformance location still needs the E18.44 remainder Loop to leave the workspace green, not only the `annex_b` crate test.
...
- **Re-opening [[slice-269-e18-44]]**: that slice stays sealed `failed`
...
- `[[task-444-e18-44-workspace-timeout]]`

## See also

ROADMAP.md E18.44, `tests/conformance/fixtures/es/annex-b`, `tests/conformance/tests/annex_b.rs`, CONTEXT.md, [[location-218-conformance]], [[slice-269-e18-44]], [[ticket-138-e18-44-workspace-timeout]].
