---
id: "slice-278-f07-workspace-timeout"
...
Review of [[slice-279-f07]] left ROADMAP F07 unfinished: O1 (`bindgen` CLI) and O2 (`bindgen_header` integration) held, but O3 `cargo test --workspace` timed out at 120s. The ffi location still needs the F07 Loop to leave the workspace green, not only the bindgen harnesses.
...
- **Re-opening [[slice-279-f07]]**: that slice stays sealed `failed`
...
- `[[task-454-f07-workspace-timeout]]`

## See also

ROADMAP.md F07, `crates/draconic-cli/tests/bindgen.rs`, `crates/draconic-cli/src/c_header.rs`, `tests/integration/tests/bindgen_header.rs`, docs/adr/0002-shared-ir-dual-backends.md, docs/adr/0003-gc-runtime-and-dual-worlds.md, CONTEXT.md, [[location-221-ffi]], [[slice-279-f07]], [[ticket-143-f07-workspace-timeout]].
