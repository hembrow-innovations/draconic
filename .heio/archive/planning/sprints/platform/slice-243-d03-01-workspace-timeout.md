---
id: "slice-243-d03-01-workspace-timeout"
...
Review of [[slice-244-d03-01]] left ROADMAP D03.01 unfinished: O1 (`reproducibility_expectations`) held, but O2 `cargo test --workspace` timed out at 120s. The distribution location still needs the D03.01 Loop to leave the workspace green, not only the reproducibility docs suite.
...
- **Re-opening [[slice-244-d03-01]]**: that slice stays sealed `failed`
...
- `[[task-419-d03-01-workspace-timeout]]`

## See also

ROADMAP.md D03.01, `tests/integration/tests/reproducibility_expectations.rs`, `website/install.md`, docs/, CONTEXT.md, [[location-224-distribution]], [[slice-244-d03-01]], [[ticket-128-d03-01-workspace-timeout]].
