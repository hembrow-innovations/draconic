---
id: "slice-292-h04-workspace-timeout"
...
Review of [[slice-293-h04]] left ROADMAP H04 unfinished: O1 (`host_fs`) held, but O2 `cargo test --workspace` timed out at 120s. The host-io location still needs the H04 Loop to leave the workspace green, not only the host fs conformance harness.
...
- **Re-opening [[slice-293-h04]]**: that slice stays sealed `failed`
...
- `[[task-468-h04-workspace-timeout]]`

## See also

ROADMAP.md H04, `tests/conformance/tests/host_fs.rs`, `tests/conformance/fixtures/host/fs`, `crates/draconic-backend-llvm/src/host_fs.rs`, docs/adr/0008-host-io-sockets-first-http.md, CONTEXT.md, `.heio/planning/locations/location-219-host-io.md`, [[slice-293-h04]], [[ticket-150-h04-workspace-timeout]].
