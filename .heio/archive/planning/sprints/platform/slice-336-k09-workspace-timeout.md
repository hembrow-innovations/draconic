---
id: "slice-336-k09-workspace-timeout"
...
Review of [[slice-337-k09]] left ROADMAP K09 unfinished: O1 (`k09_01_resolve_fetch`) and O2 (`k09_02_build_consumer`) held, but O3 `cargo test --workspace` timed out at 120s. The packages location still needs the K09 Loop to leave the workspace green, not only the temp git dep + consumer Program package tests.
...
- **Re-opening [[slice-337-k09]]**: that slice stays sealed `failed`
...
- `[[task-512-k09-workspace-timeout]]`

## See also

ROADMAP.md K09, `tests/packages/tests/k09_01_resolve_fetch.rs`, `tests/packages/tests/k09_02_build_consumer.rs`, docs/adr/0009-go-style-git-packages.md, CONTEXT.md, `.heio/planning/locations/location-220-packages.md`, [[slice-337-k09]], [[ticket-172-k09-workspace-timeout]].
