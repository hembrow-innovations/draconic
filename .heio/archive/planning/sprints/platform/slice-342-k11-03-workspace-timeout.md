---
id: "slice-342-k11-03-workspace-timeout"
...
Review of [[slice-343-k11-03]] left ROADMAP K11.03 unfinished: O1 (`draconic-pkg` subdir) held, but O2 `cargo test --workspace` timed out at 120s. The packages location still needs the K11.03 Loop to leave the workspace green, not only the multi-module monorepo subdir module path crate tests.
...
- **Re-opening [[slice-343-k11-03]]**: that slice stays sealed `failed`
...
- `[[task-518-k11-03-workspace-timeout]]`

## See also

ROADMAP.md K11.03, `crates/draconic-pkg`, docs/adr/0009-go-style-git-packages.md, CONTEXT.md, `.heio/planning/locations/location-220-packages.md`, [[slice-343-k11-03]], [[ticket-175-k11-03-workspace-timeout]].
