---
id: "slice-284-h00-workspace-timeout"
...
Review of [[slice-285-h00]] left ROADMAP H00 unfinished: O1 (`host_policy`) and O2 (`draconic-runtime` lib) held, but O3 `cargo test --workspace` timed out at 120s. The host-io location still needs the H00 Loop to leave the workspace green, not only the host policy harness and Runtime ABI tests.
...
- **Re-opening [[slice-285-h00]]**: that slice stays sealed `failed`
...
- `[[task-460-h00-workspace-timeout]]`

## See also

ROADMAP.md H00, `tests/conformance/tests/host_policy.rs`, `tests/conformance/fixtures/host/policy`, `crates/draconic-runtime`, `crates/draconic-check/src/host_api.rs`, docs/adr/0008-host-io-sockets-first-http.md, CONTEXT.md, `.heio/planning/locations/location-219-host-io.md`, [[slice-285-h00]], [[ticket-146-h00-workspace-timeout]].
