---
id: "slice-247-d03-workspace-timeout"
...
Review of [[slice-248-d03]] left ROADMAP D03 unfinished: O1 (`reproducible_builds`) held, but O2 `cargo test --workspace` timed out at 120s. The distribution location still needs the D03 Loop to leave the workspace green, not only the same-source-plus-pin suite.
...
- **Re-opening [[slice-248-d03]]**: that slice stays sealed `failed`
...
- `[[task-423-d03-workspace-timeout]]`

## See also

ROADMAP.md D03, `tests/integration/tests/reproducible_builds.rs`, CONTEXT.md, [[location-224-distribution]], [[slice-248-d03]], [[ticket-130-d03-workspace-timeout]].
