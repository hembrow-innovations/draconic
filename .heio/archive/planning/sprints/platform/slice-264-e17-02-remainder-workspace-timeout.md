---
id: "slice-264-e17-02-remainder-workspace-timeout"
...
Review of [[slice-265-e17-02-remainder]] left ROADMAP E17.02 unfinished: O1 (legacy harness) held, but O2 `cargo test --workspace` timed out at 120s. The conformance location still needs the E17.02 remainder Loop to leave the workspace green, not only the `legacy` crate test.
...
- **Re-opening [[slice-265-e17-02-remainder]]**: that slice stays sealed `failed`
- **Re-opening [[slice-267-e17-02]]**: that slice stays sealed `failed`
...
- `[[task-440-e17-02-remainder-workspace-timeout]]`

## See also

ROADMAP.md E17.02, `tests/conformance/fixtures/es/legacy`, `tests/conformance/tests/legacy.rs`, CONTEXT.md, [[location-218-conformance]], [[slice-267-e17-02]], [[slice-265-e17-02-remainder]], [[slice-266-e17-02-workspace-timeout]], [[ticket-137-e17-02-remainder-workspace-timeout]].
