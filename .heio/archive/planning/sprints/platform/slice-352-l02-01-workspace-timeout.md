---
id: "slice-352-l02-01-workspace-timeout"
...
Review of [[slice-353-l02-01]] left ROADMAP L02.01 unfinished: O1 (`stdlib_collections`) held, but O2 `cargo test --workspace` timed out at 120s. The stdlib location still needs the L02.01 Loop to leave the workspace green, not only the collections conformance fixtures for `groupBy` / `chunk` (or designed names) on arrays.
...
- **Re-opening [[slice-353-l02-01]]**: that slice stays sealed `failed`
...
- `[[task-528-l02-01-workspace-timeout]]`

## See also

ROADMAP.md L02.01, `tests/conformance/tests/stdlib_collections.rs`, `tests/conformance/fixtures/stdlib/collections`, CONTEXT.md, [[location-223-stdlib]], [[slice-353-l02-01]], [[ticket-180-l02-01-workspace-timeout]].
