---
id: "task-555-p04-workspace-tests"
...
Reviewer miss on [[slice-380-p04]]. O2 printed EXPECT in crate output but `cargo test --workspace` exited 101. Product fail, not an oracle-budget timeout. Not a new P04 Loop atom. P04 stays `done`.
...
[[slice-379-p04-workspace-tests]] [[ticket-194-p04-workspace-tests]]
