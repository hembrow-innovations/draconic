---
id: "task-442-e17-02-workspace-timeout"
...
Roadmap ID **E17.02** (other non-strict legacy beyond `with`). Review of [[slice-267-e17-02]] left O2 unmet: `cargo test --workspace` timed out at 120s while the legacy harness stayed green. If the hang comes from the E17.02 remainder change, fix that remainder so both checks hold. Leave E17.02 `todo` while untracked remainder remains. Mark E17.02 `done` only when no untracked remainder stays. Not E17.01, E18.44, N08.15, or Test262 full allowlist. Do not re-open [[slice-267-e17-02]].
...
[[slice-266-e17-02-workspace-timeout]] [[ticket-28-e17-02-workspace-timeout]] [[slice-267-e17-02]] [[task-441-e17-02-remainder]]
