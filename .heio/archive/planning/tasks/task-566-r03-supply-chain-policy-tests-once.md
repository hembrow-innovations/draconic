---
id: "task-566-r03-supply-chain-policy-tests-once"
title: "R03 Supply-chain policy tests once K08 lands (lock verify refuse tamper)"
kind: task
status: completed
mode: afk
blocked_by: ["task-563-r03-01-integration-tampered-cache-refused", "task-564-r03-02-integration-lock-hash-mismatch-hard"]
tags: []
...
[[task-563-r03-01-integration-tampered-cache-refused]] and [[task-564-r03-02-integration-lock-hash-mismatch-hard]]. K08 already landed. Parent remainder waits until those child atoms land so Build does not duplicate those Loops.
...
[[slice-392-r03]] [[ticket-110-r03-supply-chain-policy-tests-once]]
