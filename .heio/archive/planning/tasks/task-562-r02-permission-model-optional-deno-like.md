---
id: "task-562-r02-permission-model-optional-deno-like"
title: "R02 Permission model (optional Deno-like): grant/deny fs and net; clear deny diagnostics"
kind: task
status: completed
mode: afk
blocked_by: ["task-558-r02-01-permission-grants-fs-read-write", "task-559-r02-02-deny-path-clear-diagnostic", "task-560-r02-03-cli-runtime-flags-to-grant", "task-561-r02-04-default-policy-documented"]
tags: []
...
[[task-558-r02-01-permission-grants-fs-read-write]], [[task-559-r02-02-deny-path-clear-diagnostic]], [[task-560-r02-03-cli-runtime-flags-to-grant]], and [[task-561-r02-04-default-policy-documented]]. Parent remainder waits until those child atoms land so Build does not duplicate those Loops.
...
[[slice-387-r02]] [[ticket-105-r02-permission-model-optional-deno-like]]

## Gauntlet

- **round 1**: `cargo test -p draconic-conformance --test permissions` — win. `test result: ok.` 33 passed. `cargo test --workspace` every crate `test result: ok.` ROADMAP R02 `done`.
