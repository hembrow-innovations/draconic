---
id: "task-444-e18-44-workspace-timeout"
...
Roadmap ID **E18.44** (Untracked ECMA-262 remainder beyond E01–E18 children; file finer rows as discovered; do not drop). Review of [[slice-269-e18-44]] left O2 unmet: `cargo test --workspace` timed out at 120s while O1 (annex-b harness) stayed green. If the hang comes from the E18.44 remainder change, fix that remainder so both the workspace check and the `annex_b` harness hold. Leave E18.44 `todo` while untracked remainder remains. Mark E18.44 `done` only when no untracked remainder stays. Not E01–E18.43 tracked children, E17.02 other non-strict legacy remainder, S02 / E19.02 Test262 allowlist expansion, or N08.16 native observations of annex-b fixtures. Do not re-open [[slice-269-e18-44]]. Do not drop E18.44 without filing finer rows.
...
[[slice-268-e18-44-workspace-timeout]] [[ticket-138-e18-44-workspace-timeout]] [[slice-269-e18-44]]
