---
id: "task-476-h08-workspace-timeout"
...
Roadmap ID **H08** (UDP). Review of [[slice-301-h08]] left O2 unmet: `cargo test --workspace` timed out at 120s while O1 (`host_udp`) stayed green. If the hang comes from the H08 change, fix that UDP bind/sendto/recvfrom/close and loopback surface so both the workspace check and the host UDP harness hold. Mark H08 `done` only when those tests are green. Not H08.01 UDP bind / sendto / recvfrom / close, H08.02 UDP loopback e2e, H06 TCP listen/accept/connect/read/write, H07 async socket I/O + job queue, H09 DNS, H10 HTTP/1.1 thin helpers, or H00 host I/O surface policy. Do not re-open [[slice-301-h08]].
...
[[slice-300-h08-workspace-timeout]] [[ticket-154-h08-workspace-timeout]] [[slice-301-h08]]
