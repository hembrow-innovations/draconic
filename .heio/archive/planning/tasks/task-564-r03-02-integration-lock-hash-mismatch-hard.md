---
id: "task-564-r03-02-integration-lock-hash-mismatch-hard"
...
[[slice-390-r03-02]] [[ticket-112-r03-02-integration-lock-hash-mismatch-hard]]

## Gauntlet

- **round 1**: `cargo test -p draconic-integration-tests --test supply_chain_lock_hash_mismatch` — win (`test result: ok.`). `cargo test --workspace` — win (`test result: ok.`). Gap: none.
