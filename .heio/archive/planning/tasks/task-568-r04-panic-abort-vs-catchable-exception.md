---
id: "task-568-r04-panic-abort-vs-catchable-exception"
...
[[slice-394-r04]] [[ticket-113-r04-panic-abort-vs-catchable-exception]]

## Gauntlet

- **round 1**: `cargo test -p draconic-runtime --lib abort_policy`; `cargo test -p draconic-conformance --test panic_policy`; `cargo test --workspace` — win. All three printed `test result: ok.` Invariant root-stack underflow abort locked; R04 marked `done`.
