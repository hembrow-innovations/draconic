---
id: "task-552-l10-crypto-later-hmac-aead-after"
title: "L10 Crypto later: HMAC + AEAD (after L03)"
kind: task
status: completed
mode: afk
blocked_by: ["task-549-l10-01-hmac-sha256-after-l03", "task-550-l10-02-aead-encrypt-decrypt-after-l03"]
tags: []
...
[[task-549-l10-01-hmac-sha256-after-l03]] and [[task-550-l10-02-aead-encrypt-decrypt-after-l03]]. L03 already landed. Parent remainder waits until HMAC-SHA256 and AEAD child atoms land so Build does not duplicate those Loops.
...
[[slice-378-l10]] [[ticket-90-l10-crypto-later-hmac-aead-after]]
