---
id: "task-534-l04-workspace-timeout"
...
Roadmap ID **L04** (`Compression later: gzip/deflate byte buffers`). Review of [[slice-359-l04]] left O2 unmet: `cargo test --workspace` timed out at 120s while O1 (`stdlib_compression`) stayed green. The stdlib location still needs the L04 Loop to leave the workspace green, not only the gzip/deflate byte-buffer conformance fixtures. If the hang comes from the L04 change, fix that gzip/deflate byte-buffer surface so both the workspace check and those fixtures hold. Mark L04 `done` only when those tests are green. Not L01 encoding, L03 crypto, L09 MIME, L10 HMAC/AEAD, zip/tar/brotli/zstd, a Node `zlib` identity surface, or changing the L v1 done bar to require L04. Do not re-open [[slice-359-l04]].
...
[[slice-358-l04-workspace-timeout]] [[ticket-182-l04-workspace-timeout]] [[slice-359-l04]]
