---
id: "task-563-r03-01-integration-tampered-cache-refused"
...
[[slice-388-r03-01]] [[ticket-111-r03-01-integration-tampered-cache-refused-depends]]

## Gauntlet

- **round 1**: `cargo test -p draconic-integration-tests --test supply_chain_tampered_cache` — win (`test result: ok.`). `cargo test --workspace` — win (`test result: ok.`). Gap: none.
