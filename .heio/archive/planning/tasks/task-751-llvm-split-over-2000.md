---
id: "task-751-llvm-split-over-2000"
title: "Split llvm arrays generators ints promise"
kind: task
status: completed
mode: afk
...
# Split llvm arrays generators ints promise
...
Each of es_arrays.rs, es_generators.rs, native_ints.rs, es_promise.rs is ≤1000, or replaced by sibling files each ≤1000. Public emit entry unchanged.

## Context

size-file-budget on es_arrays.rs, es_generators.rs, native_ints.rs, es_promise.rs. Split by a deeper feature seam inside each file. Move same-file tests with the seam. Do not edit other oversized LLVM files in this sitting.

## Verify

cargo test -p draconic-backend-llvm. Named files and new siblings ≤1000.

scope: crates/draconic-backend-llvm/src/es_arrays.rs, crates/draconic-backend-llvm/src/es_generators.rs, crates/draconic-backend-llvm/src/native_ints.rs, crates/draconic-backend-llvm/src/es_promise.rs and new sibling modules those files declare
...
**Category:** layout
**Summary:** Split es_arrays.rs, es_generators.rs, native_ints.rs, es_promise.rs under 1000 lines.
...
**Current behavior:**
es_arrays.rs, es_generators.rs, native_ints.rs, es_promise.rs over the line budget.
